...
function Projects() {
    return (
        <div className="w-screen h-screen flex flex-col  bg-color-20 text-color-10">
            ...
            <div className="bubbles h-screen xl:h-[110vh] w-screen grid grid-cols-5 grid-rows-5 bg-color-20  p-4">
                <a
                ...
                ></a>
                <a
                    className="five w-20 h-20 md:w-32 md:h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 col-start-1 col-end-2  row-start-3 row-end-4 flex justify-center items-center border-8 border-color-40  hover:outline-8 hover:outline-color-10 bg-mathenerds bg-no-repeat bg-center bg-cover overflow-hidden -mt-16 md:mt-0"
                ...
                ></a>
                <a
                    className="seven w-20 h-20 md:w-32 md:h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 col-start-1 col-end-2  row-start-4 row-end-5 flex justify-center items-center border-8 border-color-40  hover:outline-8 hover:outline-color-10 bg-sticky bg-no-repeat bg-center bg-cover overflow-hidden lg:mt-16 xl:mt-20"
                ...
                <a
                    className="eleven w-20 h-20 md:w-32 md:h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 col-start-2 col-end-3  row-start-5 row-end-6 bg-color-10 text-color-20 flex justify-center items-center border-8 border-color-40  hover:outline-8 hover:outline-color-10 bg- bg-no-repeat bg-center bg-[#] bg-cover overflow-hidden text-4xl lg:-mt-20 lg:ml-40 xl:-mt-0 "
                    href=""
                    target="_blanked"
                >
                    <BiCodeAlt />
