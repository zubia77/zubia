...
function Contact() {
    ...
    return (
        <div className="w-screen">
            <div className=" text-color-20 flex flex-col  bg-color-10">
                <Navbar />
                <NavbarMobile />
                <div className="w-[100vw]  md:mt-10 flex flex-col justify-center items-center shrink">
                    <h1 className="px-10 text-3xl text-color-20 font-style10 md:text-5xl">
                        Please get in touch!
                    </h1>
